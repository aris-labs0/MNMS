...
export default function Component() {
  const { data, isLoading, error } = api.dashboard.getStatusHistory.useQuery()
          ...
          <AreaChart data={data} margin={{ right: 12 }}>
            <defs>
              <linearGradient id="fillStatus" x1="0" y1="0" x2="0" y2="1">
                ...
                <stop offset="100%" stopColor="var(--color-status)" stopOpacity={0.1} />
              </linearGradient>
            </defs>
            ...
            <ChartTooltip cursor={false} content={<ChartTooltipContent labelFormatter={formatTime} indicator="dot" />} />
